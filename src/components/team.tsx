  ...
  const management = [
    {
      name: "Şevval KARAMAN",
      role: "Başkan",
      linkedin: "https://www.linkedin.com/in/%C5%9Fevvalkaraman/",
    },
    {
      name: "İsmail Ayberk SAĞ",
      role: "Başkan Yardımcısı",
      linkedin: "https://www.linkedin.com/in/ismailayberksag/",
    },
    {
      name: "Didem Tuğba KAZEL",
      role: "Kurumsal İletişim Koordinatörü",
      linkedin: "https://www.linkedin.com/in/didem-tu%C4%9Fba-kazel-687b28385/",
    },
    {
      name: "Neşetcan AYDOĞAN",
      role: "Dijital Tasarım Sorumlusu",
      linkedin: "https://www.linkedin.com/in/canaydogantabb/",
    },
    {
      name: "Sümeyra ÖZCAN",
      role: "Sosyal Medya Koordinatörü",
      linkedin:
        "https://www.linkedin.com/in/s%C3%BCmeyra-%C3%B6zcan-b56aa6383/",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-32">
          ...
          >
            ...
            <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium leading-relaxed">
              Disiplinler arası çalışma kültürü ve yüksek motivasyona sahip
              laboratuvarımızın yönetim kadrosu.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-40">
          {management.map((member, i) => (
            ...
            >
              ...
              <h4 className="text-xl font-black mb-2 font-exo2 tracking-tighter leading-tight">
                {member.name}
              </h4>
              <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest leading-relaxed opacity-60 mb-6">
                {member.role}
              </p>
              ...
              <div className="flex justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                ...
                >
                  <Linkedin
                    size={24}
                    className="text-slate-400 hover:text-primary cursor-pointer transition-all"
                  />
                </a>
              </div>
            </motion.div>
        ...
        <div className="text-center">
          <div className="inline-block p-12 glass dark:glass-dark rounded-[60px] border border-white/40 shadow-premium relative overflow-hidden">
            ...
            <h3 className="text-4xl font-black font-exo2 mb-12 tracking-tighter">
              DANIŞMANLARIMIZ
            </h3>
            <div className="flex flex-wrap justify-center gap-20">
              {advisors.map((advisor, i) => (
                ...
                >
                  ...
                  <div className="font-black text-xl font-exo2 tracking-tighter mb-1">
                    {advisor.name}
                  </div>
                  <div className="text-xs font-black uppercase tracking-widest text-slate-500 opacity-60">
                    {advisor.role}
                  </div>
                  <Mail
                    size={16}
                    className="text-slate-400 hover:text-secondary cursor-pointer mt-4"
                  />
                </motion.div>
              ))}
            </div>
